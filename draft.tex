...
\title{TASK-AWARE ANALYSIS OF JPEG RECOMPRESSION AND BIT-DEPTH REDUCTION FOR EFFICIENT IMAGE COMPRESSION IN OBJECT DETECTION}
...
\section{Introduction (Literary review)}
...
Table \ref{tab:results} compiles the complete experimental results for all 11 validation subsets. 

\begin{table*}[t]
\centering
\caption{Comprehensive quantitative results for original, JPEG, and BPC variants on COCO val2017 using YOLOv8n.}
\label{tab:results}
\begin{tabular}{|l|c|r|c|c|c|c|c|c|c|c|}
\hline
\textbf{Variant} & \textbf{Type} & \textbf{Size (MB)} & \textbf{CR} & \textbf{Precision} & \textbf{Recall} & \textbf{mAP50} & \textbf{mAP50-95} & \textbf{PSNR (dB)} & \textbf{SSIM} & \textbf{$\Delta$ mAP50} \\ \hline
original & original & 776.9634 & 1.00x & 0.6347 & 0.4739 & 0.5187 & 0.3681 & — & — & 0.00\% \\ \hline
q94 & JPEG & 543.3825 & 1.43x & 0.6357 & 0.4691 & 0.5162 & 0.3660 & 37.4721 & 0.9677 & 0.48\% \\ \hline
q88 & JPEG & 384.2208 & 2.02x & 0.6446 & 0.4641 & 0.5147 & 0.3647 & 35.3911 & 0.9477 & 0.77\% \\ \hline
q75 & JPEG & 239.2142 & 3.25x & 0.6234 & 0.4660 & 0.5057 & 0.3563 & 32.2933 & 0.9055 & 2.51\% \\ \hline
q50 & JPEG & 156.6916 & 4.96x & 0.6003 & 0.4456 & 0.4814 & 0.3360 & 30.1392 & 0.8662 & 7.19\% \\ \hline
q25 & JPEG & 95.9412 & 8.10x & 0.5682 & 0.3783 & 0.4073 & 0.2742 & 28.1373 & 0.8142 & 21.48\% \\ \hline
b7 & BPC & 1912.6668 & 0.41x & 0.6328 & 0.4761 & 0.5189 & 0.3680 & 51.2191 & 0.9980 & -0.04\% \\ \hline
b4 & BPC & 816.7964 & 0.95x & 0.6081 & 0.4596 & 0.4987 & 0.3509 & 34.4830 & 0.9064 & 3.86\% \\ \hline
b3 & BPC & 607.8120 & 1.28x & 0.5808 & 0.4097 & 0.4393 & 0.3040 & 27.8577 & 0.7862 & 15.31\% \\ \hline
b2 & BPC & 322.7558 & 2.41x & 0.4904 & 0.2884 & 0.2912 & 0.1942 & 20.5138 & 0.6009 & 43.86\% \\ \hline
b1 & BPC & 165.5969 & 4.69x & 0.3859 & 0.1501 & 0.1328 & 0.0827 & 10.9245 & 0.3089 & 74.40\% \\ \hline
\end{tabular}
\end{table*}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{results/article_figures/fig1_map50_vs_size.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{results/article_figures/fig2_compression_ratio_vs_map50.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{results/article_figures/fig3_relative_map50_drop.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{results/article_figures/fig4_dataset_size_bars.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{results/article_figures/fig5_detection_metric_bars.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{results/article_figures/fig6_psnr_vs_map50.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{results/article_figures/fig7_ssim_vs_map50.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{results/article_figures/fig8_jpeg_visual_degradation_grid.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{results/article_figures/fig9_bpc_visual_degradation_grid.pdf}
...
\begin{enumerate}
    \item \textbf{JPEG Dominance}: For machine-centric vision pipelines operating under a fixed storage footprint, JPEG recompression is vastly superior to uniform bit-depth reduction stored in PNG.
    \item \textbf{Optimal Regimes}: The JPEG quality factor \textbf{q88} represents the most efficient practical operating point, halving the dataset storage size (2.02$\times$ compression) with less than a 1\% relative drop in object detection accuracy ($mAP50 = 0.5147$ vs. baseline $0.5187$). For tighter budgets, \textbf{q75} provides 3.25$\times$ compression with only a 2.51\% mAP50 drop.
    \item \textbf{The BPC Storage Failure}: Uniform RGB bit-depth reduction stored in PNG is highly inefficient. It introduces spatial banding that disrupts the PNG DEFLATE compressor, causing file size inflation at high bit depths ($b7$ is 2.46$\times$ larger than baseline) and collapsing downstream detection accuracy at lower bit depths.
    \item \textbf{Metric Divergence}: Traditional visual quality metrics (PSNR, SSIM) diverge significantly from neural network task metrics (mAP), proving that human-centric evaluation is insufficient for machine vision engineering.
\end{enumerate}
