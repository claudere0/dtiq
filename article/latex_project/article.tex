...
\author{
  ...
  \small amirkarataev1501@gmail.com, ORCID: 0000-0002-XXXX-XXXX \\
...
To compare storage efficiency and detection quality across variants without relying on matched parameter settings, Fig. 8 plots all non-baseline variants in the size--mAP50 plane and marks the Pareto frontier (points for which no other tested variant simultaneously achieves lower storage and higher mAP50).

\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{results/article_figures/fig10_pareto_storage_map50.png}
\caption{Storage-detection Pareto frontier for tested JPEG and BPC variants.}
\label{fig:pareto_frontier}
\end{figure}

The Pareto frontier is dominated by JPEG variants from $q88$ through $q25$. No BPC point lies on the frontier: even when BPC achieves smaller files at aggressive quantization levels, its mAP50 remains far below JPEG variants at comparable storage budgets (for example, $b1$ at 165.60 MB vs. $q25$ at 95.94 MB).
